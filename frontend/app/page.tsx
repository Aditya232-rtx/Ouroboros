...
export default function Home() {
  ...
  const handleScan = () => {
    ...
    if (!user) {
      // If not logged in, redirect to login with return url (optional, simpler to just go to login)
      router.push("/login");
      return;
    }
    ...
    if (repoLink && githubPattern.test(repoLink)) {
      ...
      // Redirect to War Room with repo param
      router.push(`/warloop?repo=${encodeURIComponent(repoLink)}`);
    } else {
            ...
            <div className="flex items-center space-x-6">
              ...
              {user ? (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="h-8 w-8 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-medium">
