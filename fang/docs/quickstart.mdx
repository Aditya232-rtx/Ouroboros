---
title: "Quick Start"
description: "Install Fang and run your first security scan"
---
...
<Note>
First run pulls the Docker sandbox image automatically. Results are saved to `fang_runs/<run-name>`.
</Note>

## Target Types

Fang accepts multiple target types:
...
fang -t https://github.com/org/repo -t https://your-app.com
