---
title: "Contributing"
description: "Contribute to Fang development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `fang/skills/`
...
the sidecar as `fang/bin/fang-tui`, and assigns the current platform tag.
Frozen releases built by `scripts/build.sh` and `fang.spec` also require the
sidecar.
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/fang-ai">
    Join the community for help and discussion.
  </Card>
  <Card title="GitHub Issues" icon="github" href="https://github.com/Aditya232-rtx/fang/issues">
