...
Skip the setup. Run Fang in the cloud at [app.fang.ai](https://app.fang.ai).
...
1. Sign up at [app.fang.ai](https://app.fang.ai)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try Fang Cloud" icon="rocket" href="https://app.fang.ai">
