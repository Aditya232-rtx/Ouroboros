---
title: "Azure OpenAI"
description: "Configure Fang with OpenAI models via Azure"
---

## Setup

```bash
export FANG_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `FANG_LLM` | `azure/<your-deployment-name>` |
...
```bash
export FANG_LLM="azure/gpt-5.4-deployment"
