---
title: "AWS Bedrock"
description: "Configure Fang with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install Fang with the bedrock extra:

```bash
pipx install "fang-agent[bedrock]"
```

## Setup

```bash
export FANG_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
