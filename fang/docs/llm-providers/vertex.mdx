...
description: "Configure Fang with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Fang with the vertex extra:

```bash
pipx install "fang-agent[vertex]"
```

## Setup

```bash
export FANG_LLM="vertex_ai/gemini-3-pro-preview"
```
