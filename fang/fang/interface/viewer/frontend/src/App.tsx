...
const TRUST_BANNER =
  "Your findings stay on your machine. They're rendered here locally in your browser and never uploaded or stored by Fang.";
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="border-b border-[#222]">
          <div className="max-w-[88rem] mx-auto px-3 sm:px-6 py-4 flex items-center gap-1.5">
            ...
            >
              <img src="./logo.png" alt="Fang" className="w-10 h-8 object-cover" />
              <div className="text-base text-white font-medium tracking-tight">Fang</div>
            </a>
...
function AgentsTab({ run, canSteer }: { run: LoadedRun; canSteer: boolean }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Re-run always routes to Fang Cloud. */}
      <div className="rounded-xl border border-[#222] bg-[rgba(255,255,255,0.02)] p-5">
        ...
        <div className="mt-3 flex flex-wrap gap-2.5">
          <ProInlineCta
            label="Re-run in Fang Pro with more depth"
