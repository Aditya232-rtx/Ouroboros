 ...
 *
 * The OSS fang engine (Aditya232-rtx/fang) is the source of truth for tool names:
 * see `fang/tools/**` for definitions and `fang/interface/tui/renderers/` for
...
const CATEGORY_TOOLS: Record<ToolCategory, readonly string[]> = {
  ...
  search: ["web_search"],
  // scan_start_info / subagent_start_info are fang-app synthetic events; finish_scan is the engine's
