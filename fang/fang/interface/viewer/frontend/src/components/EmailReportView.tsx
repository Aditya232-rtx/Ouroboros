...
const SEND_ERRORS: Record<string, string> = {
  forbidden: "This email was unsubscribed from Fang, so we cannot send to it.",
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex items-start gap-2.5">
                ...
                <p className="text-xs leading-relaxed text-[#aaa]">
                  Only you hold the password; Fang can&apos;t read it.
                </p>
              </div>
            </div>
            <button
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-[#666]">
                Save this now. Fang never stores it, so we cannot show it again. File:{" "}
