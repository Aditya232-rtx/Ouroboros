 ...
 * description of the feature plus what Fang Cloud includes. The local viewer
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h2 className="text-lg text-white">Available in Fang Cloud</h2>
          {description && (
        ...
        <div className="space-y-4 pt-4">
          <div className="rounded-xl border border-[#333] bg-[#0a0a0a] p-4 sm:rounded-lg">
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-white">Fang Cloud also includes</span>
            </div>
