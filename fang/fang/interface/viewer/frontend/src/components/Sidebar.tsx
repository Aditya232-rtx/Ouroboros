...
const WIDTH_KEY = "fang_viewer_sidebar_width";
const COLLAPSE_KEY = "fang_viewer_sidebar_collapsed";
...
export default function Sidebar({
  ...
  return (
    <>
      ...
      >
        {/* Header — account-switcher stand-in (links out to Fang Cloud). */}
        <header className="relative flex flex-col gap-1 pt-1 min-w-[160px]">
          <div className="flex flex-row py-1 px-2">
            <div className="flex h-10 w-full flex-row items-center">
              <a
                href={ctaUrl("https://app.fang.ai", "logo")}
                target="_blank"
              ...
              >
                ...
                <span className="flex flex-1 flex-row items-center gap-2 min-w-0">
                  <span className="truncate min-w-0 text-[14px] font-medium text-[#ededed]">Fang</span>
          ...
          <div className="relative flex flex-col gap-px px-2">
            ...
            <NavItem
              ...
              onClick={() =>
                openUpgrade(
                  "pr_reviews",
                  "Fang reviews every pull request and flags exploitable changes before they merge."
                )
              }
            />
            <NavItem
