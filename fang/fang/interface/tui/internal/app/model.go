...
// It is set by main from the FANG_VERSION env var (see go_tui.py), matching
// Python's get_package_version() which reads the installed "fang-agent" version
...
const (
	...
	setupPlaceholderShort = "What should Fang test?"
...
// splashTick drives the splash "Starting Fang Agent" shimmer at Python's 0.1s cadence.
