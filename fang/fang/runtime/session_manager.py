...
from fang.runtime.backends import backend_supports_bind_mounts, get_backend
from fang.runtime.caido_bootstrap import bootstrap_caido
...
def _host_identity_env() -> dict[str, str]:
    ...
    return {"FANG_HOST_UID": str(os.getuid()), "FANG_HOST_GID": str(os.getgid())}
