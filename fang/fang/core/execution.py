"""Execution loop for addressable SDK-backed Fang agents."""
...
from fang.core.hooks import (
    BudgetExceededError,
    BudgetPausedError,
    SubagentBudgetReservedError,
)
from fang.core.inputs import child_initial_input
from fang.core.sessions import (
...
from fang.llm.compaction import is_context_overflow, maybe_compact
...
if TYPE_CHECKING:
    ...
    from fang.core.agents import AgentCoordinator, Status
