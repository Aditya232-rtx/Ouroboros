"""Tests for graceful handling of persistent RateLimitError in run_fang_scan."""
...
async def test_persistent_rate_limit_stops_gracefully(
    ...
    monkeypatch.setattr(runner, "build_fang_agent", lambda **_kwargs: object())
    ...
    with caplog.at_level(logging.WARNING):
        result = await runner.run_fang_scan(
    ...
    assert "fang --resume scan-test" in caplog.text
