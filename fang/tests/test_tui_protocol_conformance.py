...
The wire protocol is declared twice — ``fang/interface/tui/backend/protocol.py``
for the backend and ``fang/interface/tui/internal/protocol/protocol.go`` for the
...
from fang.interface.tui.backend.protocol import PROTOCOL_CAPABILITIES, PROTOCOL_VERSION
