...
*inside* a streamed response as a bare error with no status code, so Fang adds a
...
from fang.config.models import DEFAULT_MODEL_RETRY, _retry_statusless_provider_errors
