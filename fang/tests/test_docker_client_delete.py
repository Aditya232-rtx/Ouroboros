"""FangDockerSandboxClient.delete() best-effort teardown.
...
def _client_with_kill_error(exc: Exception) -> FangDockerSandboxClient:
    """A FangDockerSandboxClient whose containers.get(...).kill() raises ``exc``."""
    client = FangDockerSandboxClient.__new__(FangDockerSandboxClient)
