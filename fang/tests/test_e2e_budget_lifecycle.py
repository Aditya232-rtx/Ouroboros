...
from fang.core.agents import AgentCoordinator, WaitKind
from fang.core.execution import _start_child_runner, run_agent_loop
from fang.core.hooks import BudgetExceededError, ReportUsageHooks
...
async def test_full_budget_lifecycle_reserve_then_cap(  # noqa: PLR0915
    ...
    with patch("fang.core.hooks.get_global_report_state", return_value=ledger):
