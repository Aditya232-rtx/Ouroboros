...
from fang.core.hooks import LLM_TURN_KEY, ReportUsageHooks
from fang.tools.agents_graph.tools import wait_for_agents
...
def _fast_wait(monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    ...
    monkeypatch.setattr(
        "fang.tools.agents_graph.tools._WAIT_DEFAULT_TIMEOUT_S", _WAIT_SECONDS, raising=True
    )
    yield
