#!/usr/bin/env python3
"""
SWE Runner with Ouro Trajectory Format

A runner that uses Ouro-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Ouro-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Ouro-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Ouro format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Ouro-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Ouro-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Ouro Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Ouro-Agent's built-in execution environments
    and outputs trajectories in Ouro-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Ouro trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Ouro trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Ouro trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Ouro Trajectory Format")
    print("=" * 60)
