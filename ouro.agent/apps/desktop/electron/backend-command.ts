// Backend subcommand routing for the desktop-managed Ouro process.
//
// The desktop app launches its own headless backend via `ouro serve` — it
 ...
 * @param {string} [profile] optional Ouro profile to pin via `--profile`.
 */
