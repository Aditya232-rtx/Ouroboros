// Launching the Ouro TUI in the user's OWN terminal emulator.
//
...
// `ouro --tui --resume <id>` there. Two problems have to be solved for that
// to work anywhere:
//
//  1. WHAT to run. The desktop's Ouro runtime is often a venv Python invoked
 ...
 * headless child) is the wrong answer for an interactive terminal. The Ouro
