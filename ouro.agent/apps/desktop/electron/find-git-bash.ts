 ...
 *   1. OURO_GIT_BASH_PATH env var override
...
export function findGitBash(opts: GitBashOptions): string | null {
  ...
  // Respect OURO_GIT_BASH_PATH if set (mirrors tools/environments/local.py:_find_bash).
  const gitBashPath = env.OURO_GIT_BASH_PATH
