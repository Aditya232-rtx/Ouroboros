...
// even though a fresh shell — and the Ouro CLI — sees it immediately. The
// desktop's OURO_HOME resolution relies on process.env, so that stale-snapshot
