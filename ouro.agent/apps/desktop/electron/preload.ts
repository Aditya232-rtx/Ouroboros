...
const desktopApi = {
  ...
  // Ouro Cloud: one portal login powers discovery + silent per-agent sign-in
...
contextBridge.exposeInMainWorld('hermesDesktop', desktopApi)
contextBridge.exposeInMainWorld('ouroDesktop', desktopApi)
