 ...
 * origin=git@github.com:Aditya232-rtx/ouro.git. A background
...
test('canonicalGitHubRemote normalizes SSH and HTTPS forms to the same value', () => {
  assert.equal(canonicalGitHubRemote('git@github.com:Aditya232-rtx/ouro.git'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('git@github.com:Aditya232-rtx/ouro'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('ssh://git@github.com/Aditya232-rtx/ouro.git'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('https://github.com/Aditya232-rtx/ouro.git'), OFFICIAL_REPO_CANONICAL)
  ...
  assert.equal(canonicalGitHubRemote('https://github.com/Aditya232-rtx/ouro/'), OFFICIAL_REPO_CANONICAL)
})
...
test('isSshRemote detects scp-like and ssh:// forms only', () => {
  assert.equal(isSshRemote('git@github.com:Aditya232-rtx/ouro.git'), true)
  assert.equal(isSshRemote('ssh://git@github.com/Aditya232-rtx/ouro.git'), true)
  assert.equal(isSshRemote('https://github.com/Aditya232-rtx/ouro.git'), false)
...
test('isOfficialSshRemote is true only for the official repo over SSH', () => {
  assert.equal(isOfficialSshRemote('git@github.com:Aditya232-rtx/ouro.git'), true)
  assert.equal(isOfficialSshRemote('git@github.com:Aditya232-rtx/ouro'), true)
  assert.equal(isOfficialSshRemote('ssh://git@github.com/Aditya232-rtx/ouro.git'), true)
...
test('isOfficialSshRemote does NOT match forks, other hosts, or HTTPS', () => {
  ...
  assert.equal(isOfficialSshRemote('git@gitlab.com:Aditya232-rtx/ouro.git'), false)
  ...
  assert.equal(isOfficialSshRemote('https://github.com/Aditya232-rtx/ouro.git'), false)
