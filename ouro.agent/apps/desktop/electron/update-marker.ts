...
export function markerPath(hermesHome) {
  return path.join(hermesHome, '.ouro-update-in-progress')
}
 ...
 *
 * The Tauri-based ouro-setup.exe takes several seconds to initialise its
 ...
 * Ouro to exit…") clobbers that still-running updater's claim: the
