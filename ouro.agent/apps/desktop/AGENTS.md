...
How to build Ouro Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Ouro surface can also
...
- A **runtime home change** (switching the underlying `OURO_HOME` profile) is
...
its shape. "Plugin" means several unrelated things across Ouro — do not assume
