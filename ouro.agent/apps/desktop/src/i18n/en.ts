...
export const en: Translations = {
  ...
  boot: {
    ready: 'Ouro Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Ouro settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Ouro backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Ouro Desktop…'
    },
    errors: {
      backgroundExited: 'Ouro background process exited.',
      backgroundExitedDuringStartup: 'Ouro background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Ouro backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Ouro',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Ouro Desktop.',
    ...
    native: {
      ...
      inputBody: 'Ouro is waiting for your response.',
      turnDoneTitle: 'Ouro finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Ouro defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the Ouro backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Ouro backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Ouro is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Ouro asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Ouro was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Ouro was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Ouro follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Ouro can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Ouro is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Ouro, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Ouro checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Ouro configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Ouro.',
    ...
    connections: {
      title: 'Connections',
      intro:
        'Register every place your agents live — this device, remote gateways on your network, and Ouro Cloud instances. All of them are stored here.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Ouro Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Ouro Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Ouro runtime managed by this app.',
      kindRemoteDesc: 'A Ouro gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Ouro Cloud account.',
      kindSshDesc: 'A Ouro install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Ouro manages (Authorization, Cookie, Host…) are ignored.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Ouro backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset OURO_DESKTOP_REMOTE_URL and OURO_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Ouro backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Ouro backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Ouro Cloud',
      cloudDesc: 'Sign in once to Ouro Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Ouro Cloud',
      cloudSignIn: 'Sign in to Ouro Cloud',
      cloudSignedIn: 'Signed in to Ouro Cloud',
      cloudNeedsSignIn: 'Sign in to Ouro Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Ouro Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Ouro Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Ouro Cloud',
      cloudSignedOutMessage: 'Cleared the Ouro Cloud session.',
      ...
      restartingMessage: 'Ouro Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Ouro ${version}` : ''}`,
      ...
      sshDesc:
        'Ouro is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Ouro path (optional)',
      sshHermesPathDesc: 'Full path to the remote ouro binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Ouro found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Ouro runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Ouro is not installed on the remote host. Install it there (curl -fsSL https://ouro.dev/install.sh | sh) or set the Ouro path.',
      sshErrPlatform:
        'Unsupported remote platform. Ouro Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Ouro on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Ouro. Review the exact configuration below — it comes from the link, not from Ouro.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Ouro runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Ouro at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via ouro curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Ouro builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Ouro to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Ouro to generate pets.',
      backgroundHint: 'You can close this — Ouro will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Ouro desktop' },
    ...
    hermesActiveSessions: (version, count) => `Ouro ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Ouro environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Ouro did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Ouro will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Ouro backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Ouro. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Ouro backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Ouro...',
    placeholderReconnecting: 'Reconnecting to Ouro…',
    ...
    attachUrlDesc: 'Ouro will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Ouro…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Ouro…',
    ...
    unsupportedMessage: 'This version of Ouro can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Ouro from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Ouro will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Ouro desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Ouro updater takes over in its own window and reopens Ouro automatically when it’s done. Please don’t reopen Ouro yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Ouro reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Ouro reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Ouro?',
    blockerBody:
      'Ouro needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Ouro',
    foreignBlockerBody:
      'Ouro can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Ouro can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Ouro needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Ouro Desktop',
    setupChoiceDesc:
      'Connect this app to a Ouro gateway you already run, or install Ouro locally on this computer.',
    connectExistingTitle: 'Connect to existing Ouro',
    ...
    installLocalTitle: 'Install Ouro locally',
    installLocalDesc: 'Download Ouro, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Ouro Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Ouro',
    remoteSetupDesc: 'Enter your gateway URL. Ouro Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Ouro gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Ouro gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Ouro',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Ouro CLI or desktop instance is running. Stop any running Ouro instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Ouro",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Ouro is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Ouro…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Ouro',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Ouro at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Ouro connects automatically',
    ...
    authorizeThere: 'Authorize Ouro there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Ouro there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Ouro Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Ouro Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Ouro will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Ouro is restarting...',
      askRestart: 'Ask Ouro to restart the server',
      lookingRestart: taskId => `Ouro is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Ouro is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Ouro finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Ouro could not restart the server.',
      stillWorking:
        'Ouro is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Ouro is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Ouro gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.ouro/config.yaml). Ouro won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Ouro needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Ouro needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Ouro Desktop to use Save Image.',
    restartToSaveImages: 'Restart Ouro Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `ouro gateway` running?'
    }
  },
