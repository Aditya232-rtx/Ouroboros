...
test('generated protocol uses ouro profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `ouro profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `ouro profiles list` for the LIVE/)
})
