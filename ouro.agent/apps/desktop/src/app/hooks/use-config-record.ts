...
export const OURO_CONFIG_KEY = ['hermes-config-record'] as const
...
export const hermesConfigKey = (profile?: null | string) =>
  profile == null ? OURO_CONFIG_KEY : ([...OURO_CONFIG_KEY, normalizeProfileKey(profile)] as const)
...
export const setHermesConfigCache = writeCache<HermesConfigRecord>(OURO_CONFIG_KEY)
