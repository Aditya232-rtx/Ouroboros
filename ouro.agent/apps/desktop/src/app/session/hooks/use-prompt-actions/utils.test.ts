...
describe('renderRpcResult', () => {
  ...
  describe('session.save', () => {
    it('echoes the saved file path', () => {
      expect(renderRpcResult({ file: '/home/user/.ouro/sessions/saved/x.json' }, 'save')).toBe(
        'Saved transcript to /home/user/.ouro/sessions/saved/x.json'
      )
    })
  })
