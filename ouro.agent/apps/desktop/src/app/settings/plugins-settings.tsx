...
// User-installed plugins first, bundled last — mirrors `ouro plugins list`.
...
// to `ouro dashboard`; model-providers/* are configured in Settings →
...
// Agent plugins live under the BACKEND's ouro home (profile-aware), so the
// path comes from the gateway — not from the renderer's local OURO_HOME.
