 ...
 *  Working in `~/www/hermes-agent`, the draft says "ouro-agent" constantly
 *  — a "Use skill: ouro-agent" pill on every mention is noise (the reported
 ...
 *  segment of a qualified form (`github/ouro-agent-dev`, `plugin:skill`). */
