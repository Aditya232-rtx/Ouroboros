...
// /api/profiles/active `current`). "default" is the root ~/.ouro. This is the
...
// Persist the choice and relaunch the backend under the new OURO_HOME. The
...
// Switch to the default (root ~/.ouro) profile — bound to ⌘1.
