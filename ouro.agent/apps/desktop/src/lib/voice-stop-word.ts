...
//
// When someone is in a hands-free "Hey Ouro" voice chat, the natural way to
...
// phrase (optionally addressed to Ouro), so a real turn that merely contains
...
// Optional address prefixes so "ouro stop" / "ok stop" / "hey hermes, stop"
 ...
 * to Ouro). Returns false for anything that merely contains "stop" as part of
