...
/** Why a known Ouro command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Ouro profile', surface: action('profile') },
  {
    name: '/skin',
  ...
  { name: '/version', description: 'Show Ouro version', surface: exec() },
 ...
 * Ouro' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Ouro and were never asked for. It is
