/**
 * Ouro skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$OURO_HOME/skins/` (or a
 ...
 * skin Ouro authors from a prompt lights up all three surfaces from one file.
 *
