/**
 * Live skin sync from the Ouro backend.
 *
 * The backend resolves the active skin (built-in or `$OURO_HOME/skins/*.yaml`)
 ...
 * stomps the user's persisted desktop theme; only a genuine name change (Ouro
