...
const GLOBALS = {
  __OURO_PLUGIN_SDK__: sdk,
  __OURO_REACT__: React,
  __OURO_REACT_JSX__: jsxRuntime,
  __OURO_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@hermes/plugin-sdk': shimUrl('__OURO_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__OURO_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__OURO_REACT_JSX__'),
    react: shimUrl('__OURO_REACT__')
  }
