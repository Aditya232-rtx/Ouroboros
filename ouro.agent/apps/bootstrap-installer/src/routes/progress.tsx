...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Ouro' : 'Setting up Ouro'

  const description = isUpdate
    ? 'Ouro is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Ouro installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
