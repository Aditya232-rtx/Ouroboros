    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Aditya232-rtx/ouro/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Aditya232-rtx/ouro',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/Aditya232-rtx/ouro/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://ouro.dev/' },
            { label: 'GitHub', href: 'https://github.com/Aditya232-rtx/ouro' },
