...
sidebar_position: 2
title: "添加工具"
description: "如何向 Ouro 添加新工具——schema、handler、注册与 toolset"
---
...
:::warning 仅限内置核心工具
本页面用于向仓库本身添加 **Ouro 内置工具**。
如果你想要个人专用、项目本地或其他自定义工具，而不修改 Ouro 核心，请使用插件方式：

- [插件](/user-guide/features/plugins)
- [构建 Ouro 插件](/developer-guide/plugins)
...
2. **`toolsets.py`** — 将工具名称添加到 `_OURO_CORE_TOOLS`（或特定 toolset）
...
- [ ] 已通过 `ouro chat -q "Use the weather tool for London"` 测试