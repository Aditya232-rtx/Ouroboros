...
To easily install the command-line and desktop applications, [download the Ouro Desktop installer](https://hermes-agent.nousresearch.com/) from our website and run it.
...
After installing, run `ouro setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Ouro safely  |
| 🧭 **[Use MCP with Ouro](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Ouro](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Ouro voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Ouro' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Ouro                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Ouro, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Ouro, Nomos, and Psyche models
