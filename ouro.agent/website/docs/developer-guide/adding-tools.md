...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Ouro — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Ouro tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Ouro core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Ouro Plugin](/developer-guide/plugins)
...
2. **`toolsets.py`** — add tool name to `_OURO_CORE_TOOLS` (or a specific toolset)
...
- [ ] Tested with `ouro chat -q "Use the weather tool for London"`
