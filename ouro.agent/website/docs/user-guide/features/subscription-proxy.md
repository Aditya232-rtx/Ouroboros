...
chat completions — use your Ouro-managed provider subscription as their
...
| Use case | "Use Ouro as a chat backend" | "Use my Portal sub from another app" |
...
This opens your browser for the Nous Portal OAuth flow. Ouro stores
the refresh token in `~/.ouro/auth.json` — the same place all Ouro
...
Model:      Ouro-4-70B    # or Ouro-4.3-36B, Ouro-4-405B
```
...
If you see `not logged in`, run `ouro portal`. If you see
