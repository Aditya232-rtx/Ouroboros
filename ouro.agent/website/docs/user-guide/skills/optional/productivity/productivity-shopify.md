...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Ouro","productType":"Apparel","tags":["test"]}}'
```
