...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/productivity/shop` |
| Path | `optional-skills/productivity/shop` |
| Version | `1.0.1` |
| Author | Joe Rinaldi Johnson (joerj123), Ouro |
| License | MIT |
...
**Reference files:**
- [catalog-mcp.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/productivity/shop/references/catalog-mcp.md) — direct catalog MCP calls + manual token exchange
- [direct-api.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/productivity/shop/references/direct-api.md) — auth, checkout, and orders API details
- [safety.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/productivity/shop/references/safety.md) — safety, security, and prompt-injection rules
- [legal.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/productivity/shop/references/legal.md) — personal-use limits and prohibited commercial uses
...
Manual token exchange, only when the CLI cannot be installed: [catalog-mcp.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/productivity/shop/references/catalog-mcp.md).
...
| Telegram (Ouro + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
...
- **Personal use only.** Limits and prohibited commercial uses: [legal.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/productivity/shop/references/legal.md). Full safety/security reference: [safety.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/productivity/shop/references/safety.md).
