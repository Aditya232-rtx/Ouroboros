...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/web-development/page-agent` |
...
- User wants **Ouro itself to drive a browser** → use Ouro' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
