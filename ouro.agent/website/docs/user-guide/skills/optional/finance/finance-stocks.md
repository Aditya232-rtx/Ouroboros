...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Ouro |
| License | MIT |
...
```
SCRIPT=~/.ouro/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.ouro/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
