...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Ouro |
| License | MIT |
...
import upstream classes into Ouro itself.
...
```bash
mkdir -p ~/.ouro/cache/darwinian-evolver && cd ~/.ouro/cache/darwinian-evolver
...
```bash
cd ~/.ouro/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.ouro/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.ouro/skills/research/darwinian-evolver
DE_DIR=~/.ouro/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Ouro core.
   Custom driver scripts under `~/.ouro/skills/...` are user-side and fine.
