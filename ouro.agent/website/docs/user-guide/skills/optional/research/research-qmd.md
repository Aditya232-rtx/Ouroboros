...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`ouro-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-ouro-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Ouro via the native MCP client. This is the preferred
...
Then configure Ouro to connect via HTTP:
