...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Ouro (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $OURO_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/).
...
# Set OURO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
