...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing ouro tool access (web_search, file ops). Stateless. |
