...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Ouro |
| License | MIT |
...
The script reads `${OURO_HOME:-~/.ouro}/.env` for two optional defaults:
...
Helper script: `~/.ouro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.ouro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${OURO_HOME:-~/.ouro}/.env`.
...
```bash
python3 ~/.ouro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.ouro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
