...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.ouro/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.ouro/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Ouro installs package this)
