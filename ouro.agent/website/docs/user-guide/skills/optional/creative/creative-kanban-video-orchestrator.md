...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/creative/kanban-video-orchestrator` |
...
short to a music video to an ASCII loop — in a Ouro Kanban pipeline that
...
3. **Generates** a setup script that creates Ouro profiles, project workspace, and the initial kanban task
...
For mapping role → which Ouro skills + toolsets it loads, see
...
3. Creates each Ouro profile via `ouro profile create --clone`
...
7. Fires the initial `ouro kanban create` task assigned to the director

Use `scripts/bootstrap_pipeline.py` to generate setup.sh from a brief +
team-design JSON. See **[references/kanban-setup.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/creative/kanban-video-orchestrator/references/kanban-setup.md)**
...
playbook, see **[references/monitoring.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/creative/kanban-video-orchestrator/references/monitoring.md)**.
...
task graphs. See **[references/examples.md](https://github.com/Aditya232-rtx/ouro/blob/main/optional-skills/creative/kanban-video-orchestrator/references/examples.md)**.
