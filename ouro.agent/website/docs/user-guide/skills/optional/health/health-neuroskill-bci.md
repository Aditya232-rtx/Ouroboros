...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/health/neuroskill-bci` |
...
Connect Ouro to a running [NeuroSkill](https://neuroskill.com/) instance to read
