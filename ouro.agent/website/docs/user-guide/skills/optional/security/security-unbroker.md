...
| | |
|---|---|
| Source | Optional — install with `ouro skills install official/security/unbroker` |
...
- **Dossiers are plaintext by default** (JSON, `0600` under `OURO_HOME`). For at-rest encryption run
