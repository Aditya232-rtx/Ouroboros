...
| [`ouro-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-ouro-agent) | Use, configure, theme, extend, and orchestrate Ouro. | `autonomous-ai-agents/hermes-agent` |
...
| [`inspecting-hermes-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-hermes-desktop-dom) | Read the live Ouro desktop DOM/CSS over CDP. | `software-development/inspecting-hermes-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .ouro/plans/; no execution. | `software-development/plan` |
