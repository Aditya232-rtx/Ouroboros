...
description: "How the Ouro Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Ouro Desktop app connects to a **gated gateway** (a hosted or
...
For Ouro specifically, native sign-in means:
...
- [Run Ouro with Nous Portal](./run-hermes-with-nous-portal.md)
