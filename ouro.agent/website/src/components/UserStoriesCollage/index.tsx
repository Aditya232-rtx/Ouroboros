  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Ouro community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Ouro &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Ouro?{' '}
        <a
          href="https://github.com/Aditya232-rtx/ouro/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
