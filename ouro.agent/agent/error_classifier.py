...
# ``data:`` field before Ouro receives a completion chunk.  Keeping this
...
#
# See: https://github.com/Aditya232-rtx/ouro/issues/27344
...
# case: a stream dies mid-response and Ouro persists a content-less
