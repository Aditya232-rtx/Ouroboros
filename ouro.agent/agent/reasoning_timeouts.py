...
first content token) routinely exceed Ouro's default chat-model
stale detectors:

* Stream stale detector:   ``OURO_STREAM_STALE_TIMEOUT``     default 180s
                           ``agent/chat_completion_helpers.py:2544``
* Non-stream stale detector: ``OURO_API_CALL_STALE_TIMEOUT``  default 90s
                           ``run_agent.py:1140``
