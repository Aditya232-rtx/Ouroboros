...
# Ouro' own machine-authored openers. A compaction handoff or a resumed
...
def auto_title_session(
    ...
    post-``ouro update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Ouro process): %s",
            e,
        )
...
def _is_real_user_turn(message: Any) -> bool:
    ...
    Ouro persists a lot of machinery under ``role="user"`` — compaction
