"""Core NeMo Relay adapter for Ouro tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Ouro tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Ouro Relay tool execution cannot run on an active event-loop thread"
    )
