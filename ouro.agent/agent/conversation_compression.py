...
def _adopt_live_compression_child(
    ...
    try:
        ...
        os.environ["OURO_SESSION_ID"] = child_session_id
    try:
    ...
    try:
        ...
        if client is None or not aux_model:
            if _aux_cfg_provider and _aux_cfg_provider != "auto":
                ...
                msg = (
                    ...
                    "compression will drop middle turns without a summary. "
                    "Run `ouro setup` or set OPENROUTER_API_KEY."
                )
        ...
        if aux_context and aux_context < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"minimum {MINIMUM_CONTEXT_LENGTH:,} required by Ouro "
        ...
        if aux_context < threshold:
            ...
            if threshold_suggestion_viable:
                ...
                msg += (
                    ...
                    f"Ouro's small-context floor and output reservation "
...
def compress_context(
    ...
    *,
    ...
    # Ouro' summarizer would only rewrite a local mirror without shrinking
    ...
    # The memory-provider context handoff below is intentionally Ouro-only:
        ...
        if agent._session_db:
            ...
            try:
                ...
                if in_place:
                    ...
                    # whose thread lacks the OURO_HOME context.
                    try:
                    ...
                    agent._session_db.publish_compression_child(
                        ...
                        or os.environ.get("OURO_SESSION_SOURCE", "cli"),
                        model=agent.model,
...
def _compress_context_via_codex_app_server(
    ...
    *,
    ...
    Ouro' normal compressor rewrites the local OpenAI-style transcript.
    That does not shrink the actual Codex app-server thread context. For this
    runtime, ask Codex to compact its own thread and keep Ouro' transcript
    unchanged.
    """
    auto_mode = str(
