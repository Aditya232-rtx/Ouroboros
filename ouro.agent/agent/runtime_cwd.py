...
_SESSION_CWD: ContextVar = ContextVar("OURO_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Ouro
    # source tree itself, which is a legitimate workspace when the user is
    # developing Ouro (per-surface policy for fallback-picked directories
