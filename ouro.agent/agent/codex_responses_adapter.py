...
# output items.  Ouro injects xAI's native ``web_search`` for the xAI
...
# server-assigned base64 blobs that can run 400+ chars, while Ouro-minted
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Ouro threading encrypted reasoning back across
    ...
    ``convert_messages``). Dropping the checkpoint costs nothing: Ouro'
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a Ouro-side metadata key and not part
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See https://github.com/Aditya232-rtx/ouro/issues/64434
