"""Vertex AI (Google Cloud) adapter for Ouro.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Ouro to use Gemini models via Google Cloud with
...
# who installed plain `ouro-agent` and only later selected a Gemini model.
try:
