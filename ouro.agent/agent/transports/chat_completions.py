...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Ouro/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Ouro'
    ...
    # is stricter (low/high). Clamp Ouro' wider effort set to what each
...
def _raise_gemini_thinking_max_tokens(
    ...
    global Ouro cap of 4096 is enough for visible text, but Ultra/high
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Ouro-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all Ouro-internal scaffolding markers (``_``-prefixed).
