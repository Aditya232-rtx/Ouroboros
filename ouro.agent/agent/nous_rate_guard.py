...
(3 SDK retries x 3 Ouro retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".ouro")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Ouro, ...) behind one endpoint.  A 429 can mean either:
