...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Ouro-Session-Id header), and an
        ...
        if env_var_enabled("OURO_DUMP_REQUEST_STDOUT"):
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # canonicalized only after Ouro sends the request. In that case model
...
def _iter_httpx_pool_objects(http_client: Any):
    ...
    Ouro' keepalive client (#10324 / ``_build_keepalive_http_client``) and
