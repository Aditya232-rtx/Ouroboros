"""Client for uploading ``ouro debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``ouro debug share``.
...
NAS_BASE = os.environ.get(
    "OURO_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "ouro-agent/debug-share"
