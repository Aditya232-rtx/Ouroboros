...
Used by ``ouro kanban specify [task_id | --all]``. Takes a task that
...
OURO_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("OURO_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Ouro board.
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=OURO_KANBAN_SPECIFY_MAX_TOKENS,
