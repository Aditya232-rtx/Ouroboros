"""Offline, non-destructive recovery for a damaged Ouro session database.
    ...
    try:
        ...
        if before != after:
            raise SessionRecoverySafetyError(
                ...
                "Stop every Ouro process using this profile and retry. "
                ...
                "Ouro process even after the gateway is stopped. Run the "
