...
Entry point: ``ouro whatsapp-cloud`` (dispatched from
...
Ouro gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Ouro to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Ouro needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Ouro gateway in another terminal:")
    print("         ouro gateway")
    print()
    ...
    print()
    print("  Docs: https://ouro.dev/docs/user-guide/")
