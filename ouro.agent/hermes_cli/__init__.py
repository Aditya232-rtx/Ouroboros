"""
Ouro CLI - Unified command-line interface for Ouro.

Provides subcommands for:
- ouro chat          - Interactive chat (same as ./hermes)
- ouro gateway       - Run gateway in foreground
- ouro gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `ouro setup` on a fresh Pi.
