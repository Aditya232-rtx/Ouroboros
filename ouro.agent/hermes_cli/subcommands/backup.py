...
def build_backup_parser(subparsers, *, cmd_backup: Callable) -> None:
    ...
    backup_parser = subparsers.add_parser(
        "backup",
        help="Back up Ouro home directory to a zip file",
        description="Create a zip archive of your entire Ouro configuration, "
        "skills, sessions, and data (excludes the ouro-agent codebase). "
