...
Used by ``ouro profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Ouro kanban board.
...
Rules:
  ...
  - Never write "Ouro profile" or other meta-narration.
