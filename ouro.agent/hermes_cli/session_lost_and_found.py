...
``ouro sessions recover --allow-partial`` normally copies rows through SQL,
...
rows back into a fresh current-schema Ouro session database.
...
# Ouro session ids are timestamps: 20260812_135332_ab12cd. This is the
