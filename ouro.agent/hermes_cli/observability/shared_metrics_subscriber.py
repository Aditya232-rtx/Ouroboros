"""Relay subscriber for the persisted Ouro shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Ouro counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Ouro shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
