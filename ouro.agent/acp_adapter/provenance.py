...
This is an additive Ouro extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Ouro head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Ouro DB session id
