...
def schema_read_probe_statements() -> tuple:
    ...
    served an empty session list after `ouro update` until the user's
    ...
    def _init_schema(self):
        ...
        if row is None:
            ...
            if current_version < 23:
                ...
                # optimization is available. `ouro sessions optimize-storage`
        ...
        if fts5_available:
            ...
            # not yet opted into `ouro db optimize`) must keep its EXISTING
