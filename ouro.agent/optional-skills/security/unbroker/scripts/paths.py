...
All per-subject data lives under PDD_DATA_DIR (default: $OURO_HOME/unbroker),
which is the same trust boundary Ouro uses for .env and OAuth tokens.
"""
...
def hermes_home() -> Path:
    return Path(os.environ.get("OURO_HOME") or (Path.home() / ".ouro"))
