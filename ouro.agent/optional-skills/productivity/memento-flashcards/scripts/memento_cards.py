...
Data file: $OURO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_OURO_HOME = Path(os.environ.get("OURO_HOME", Path.home() / ".ouro"))
DATA_DIR = _OURO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
