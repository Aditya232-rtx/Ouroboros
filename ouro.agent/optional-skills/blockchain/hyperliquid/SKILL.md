...
```bash
python ~/.ouro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.ouro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.ouro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
