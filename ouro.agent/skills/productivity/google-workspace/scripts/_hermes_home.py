"""Resolve OURO_HOME for standalone skill scripts.

Skill scripts may run outside the Ouro process (e.g. system Python,
...
instead of duplicating the ``OURO_HOME = Path(os.getenv(...))`` pattern.
"""
...
try:
    ...
    def get_hermes_home() -> Path:
        """Return the Ouro home directory (default: ~/.ouro).
