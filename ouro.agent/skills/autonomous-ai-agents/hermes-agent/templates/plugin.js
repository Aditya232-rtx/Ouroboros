/**
 * Ouro desktop plugin template. Save as:
 *   <ouro home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <ouro home> is ~/.ouro by default, or ~/.ouro/profiles/<name>
 * when running a named profile (`ouro -p <name>`). Run `ouro doctor` (or
