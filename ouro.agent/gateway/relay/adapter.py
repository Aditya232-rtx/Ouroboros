...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _relay_slack_extra(self) -> Dict[str, Any]:
        ...
        Enterprise knob shape (Ouro-config directed, relay-namespaced):
        ...
        try:
            ...
            if platform == "discord":
                ...
                if event is not None:
                    self._capture_scope(event)
                    # Phase 3: a component press carrying a Ouro prompt token
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        if itype == 3:
            # Phase 3: a component press whose custom_id is a Ouro prompt
    ...
    def _decode_prompt_token(token: str):
        ...
        — and is not — a Ouro prompt answer.
        """
        import re
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack Ouro already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # Ouro suppresses this synthetic DM thread anchor; drop it here for the
