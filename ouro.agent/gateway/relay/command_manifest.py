...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Ouro session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Ouro session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Ouro agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Ouro to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Ouro gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Ouro session in it",
