...
def _(rid, params: dict) -> dict:
    ...
    # over another app when they are back in Ouro.
        ...
        if (
            ...
            if not is_truthy_value(params.get("confirm_truncate")):
                ...
                return _err(
                    ...
                    "(update your Ouro client if a rewind was intended)",
                )
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # OURO_HOME override (the ContextVar set on the session-create
...
def _(rid, params: dict) -> dict:
    ...
    prompt = "\n".join(
        ...
        for line in [
            ...
            "Restart exactly the app intended for the Preview URL, not Ouro Desktop itself.",
            ...
            "First inspect what process, if any, owns the Preview URL port. If a stale server exists, inspect its cwd and prefer that cwd over the Ouro/Desktop process cwd.",
            ...
            "Before declaring success, verify the Preview URL responds with the intended app, not Ouro Desktop. If it serves Ouro/Desktop UI or another unrelated app, stop that process and report failure.",
    ...
    def run():
        ...
        try:
            ...
            # the session's OURO_HOME override (the ContextVar set on the
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the Ouro
