...
export const en: Translations = {
  ...
  status: {
    ...
    updateHermesConfirmMessage:
      "This runs ouro update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update Ouro?",
    updatingHermes: "Updating Ouro…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Ouro plugins (`ouro plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.ouro/plugins/?",
    removeHint: "Only user-installed plugins under ~/.ouro/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.ouro/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Ouro doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Ouro badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Ouro session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Ouro more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Ouro sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Ouro is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
