/**
 * Ouro Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__OURO_PLUGIN_SDK__`` and
 * ``window.__OURO_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__OURO_PLUGIN_SDK__`` because:
 ...
 * of calling ``fetch`` with a hand-read ``window.__OURO_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__OURO_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__OURO_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __OURO_PLUGIN_SDK__?: HermesPluginSDK;
    __OURO_PLUGINS__?: PluginRegistry;
  }
}
