 ...
 *
 * Plugins call window.__OURO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__OURO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__OURO_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__OURO_PLUGIN_SDK__ = {
    ...
    // window.__OURO_SESSION_TOKEN__ directly.
    authedFetch,
