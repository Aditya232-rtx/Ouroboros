 ...
 * `window.__OURO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Ouro brand in the top bar
 ...
 *  `window.__OURO_PLUGINS__.registerSlot(...)`.
 *
