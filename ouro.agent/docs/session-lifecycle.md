...
Counts consecutive restarts via a JSON file (`{OURO_HOME}/restart_counts.json`). If a
...
This prevents unwanted auto-resets after `ouro update`, `ouro gateway restart`,
or `/restart`.
