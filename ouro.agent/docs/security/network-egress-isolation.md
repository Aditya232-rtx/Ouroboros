...
When running Ouro inside Docker, the default `network_mode: host` gives the
...
The Ouro [SECURITY.md](../../SECURITY.md) §2 defines the trust model. The
...
#
# Usage:
#   OURO_UID=$(id -u) OURO_GID=$(id -g) docker compose up -d
#
...
- [SECURITY.md](../../SECURITY.md) — Ouro trust model and vulnerability reporting
