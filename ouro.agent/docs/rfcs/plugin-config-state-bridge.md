...
or change arbitrary Ouro configuration.
...
small host fact requested by the RFC. Settings writes use Ouro'
...
`OURO_HOME`, so one globally loaded plugin context follows multiplexed
...
```text
<OURO_HOME>/plugin-data/<plugin-data-namespace>/state.json
```
...
The implementation is covered with real temporary-Ouro-home tests for:
...
- [Issue #64227](https://github.com/Aditya232-rtx/ouro/issues/64227)
- [RFC PR #58542](https://github.com/Aditya232-rtx/ouro/pull/58542) by Topher Ross
