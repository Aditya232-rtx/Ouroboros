...
_FORCE_SYNC_ENV = "OURO_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.ouro") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.ouro to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``OURO_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, hermes_home: Path | None = None) -> None:
        ...
        Downloads the remote ``.ouro/`` directory as a tar archive,
    ...
    def _sync_back_transaction(self, hermes_home: Path | None = None) -> None:
        ...
        # against an uninitialized remote .ouro/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.ouro/skills/a.md`` →
        ``~/.ouro/skills/a.md``, a new remote file at
        ``/root/.ouro/skills/b.md`` maps to ``~/.ouro/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
