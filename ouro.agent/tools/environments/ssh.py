...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(self, host: str, user: str, cwd: str = "~",
        ...
        self._sync_manager = FileSyncManager(
            get_files_fn=lambda: iter_sync_files(f"{self._remote_home}/.ouro"),
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.ouro directory tree on remote in one SSH call."""
        base = f"{self._remote_home}/.ouro"
    ...
    def _ssh_bulk_download(self, dest: Path) -> None:
        ...
        # paths (e.g. home/user/.ouro/skills/f.py), matching _pushed_hashes keys.
        rel_base = f"{self._remote_home}/.ouro".lstrip("/")
        ssh_cmd = self._build_ssh_command()
