#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the Ouro desktop GUI.
...
def read_preview_tool(
    ...
    if callback is None:
        return tool_error("read_preview is only available in the Ouro desktop app.")
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "Ouro desktop GUI (the pane open_preview opens beside this chat). Call "
