...
Trust levels:
  - builtin:   Ships with Ouro. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.ouro/\.env|\~/\.ouro/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Ouro secrets file"),
    ...
    (r'\.ouro/config\.yaml|\.ouro/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Ouro configuration files directly"),
...
# scan. `.skillignore` is the Ouro-native name; `.clawhubignore` is honored
