...
def auth_json_path():
    """Return the Ouro auth store path, respecting OURO_HOME overrides."""
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`ouro tools`, banner/status paint, provider
...
# managed vendor's gateway URL is pinned: adding one is a Ouro release, and
