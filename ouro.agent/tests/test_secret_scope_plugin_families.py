...
class TestGoogleMeetSpawn:
    def test_child_env_carries_scoped_openai_key(
        ...
        monkeypatch.delenv("OURO_MEET_REALTIME_KEY", raising=False)
        ...
        assert child_env["OURO_MEET_REALTIME_KEY"] == "scoped-openai-key"
    ...
    def test_explicit_key_argument_still_wins(
        ...
        assert captured["env"]["OURO_MEET_REALTIME_KEY"] == "explicit-key"
