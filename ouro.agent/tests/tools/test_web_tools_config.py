...
class TestBackendSelection:
    ...
    ``ouro tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
...
class TestFirecrawlEnvResolution:
    ...
    values stored in ~/.ouro/.env were invisible to the provider."""
...
class TestSiblingProvidersEnvResolution:
    ...
    ~/.ouro/.env), not bare os.getenv. Parametrized over the four
