...
def test_dockerfile_installs_an_init_for_zombie_reaping(dockerfile_text):
    ...
    Without a PID-1 init that handles SIGCHLD, ouro accumulates zombie
    ...
    assert installed, (
        ...
        "reap orphaned subprocesses, ouro accumulates zombies in Docker "
...
def test_dockerfile_entrypoint_routes_through_the_init(dockerfile_text):
    ...
    PID 1 and ouro would run without zombie reaping.
    """
