...
def _restore_tool_modules():
    original_hermes_home = os.environ.get("OURO_HOME")
    original_modules = {
        name: module
    ...
    try:
        ...
        if original_hermes_home is None:
            ...
            os.environ["OURO_HOME"] = original_hermes_home
...
def _install_modal_test_modules(
    ...
    *,
    ...
    async def _lookup_aio(_name: str, create_if_missing: bool = False):
        return types.SimpleNamespace(name="ouro-agent", create_if_missing=create_if_missing)
