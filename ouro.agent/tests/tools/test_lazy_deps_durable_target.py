...
class TestGatingWithTarget:
    """``OURO_DISABLE_LAZY_INSTALLS=1`` must STOP blocking once a durable
...
@pytest.mark.skipif(
    os.environ.get("OURO_RUN_NETWORK_TESTS") != "1",
    reason="opt-in real-install test (set OURO_RUN_NETWORK_TESTS=1); CI runs "
