...
full credential environment. Two tiers:
  ...
  * Tier 2 (_OURO_PROVIDER_ENV_BLOCKLIST): LLM provider/tool keys — stripped
...
class TestDelegatedChildMarker:
    def test_delegated_child_context_scrubs_parent_kanban_keys_and_sets_marker(self):
        ...
        with patch.dict(
            ...
            {
                **_SAFE_SAMPLE,
                "OURO_KANBAN_TASK": "t_parent",
                "OURO_KANBAN_RUN_ID": "123",
                "OURO_KANBAN_DB": "/tmp/parent-kanban.db",
                "OURO_KANBAN_WORKSPACE": "/tmp/parent-workspace",
            },
            clear=True,
        ):
