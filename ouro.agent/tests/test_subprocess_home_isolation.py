...
Ouro state stays profile-scoped through OURO_HOME. Host subprocesses should
...
See: https://github.com/Aditya232-rtx/ouro/issues/25114
See: https://github.com/Aditya232-rtx/ouro/issues/36144
See: https://github.com/Aditya232-rtx/ouro/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def _host_mode(self, monkeypatch):
        ...
        monkeypatch.delenv("OURO_REAL_HOME", raising=False)
    ...
    def test_host_auto_keeps_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        hermes_home = real_home / ".ouro" / "profiles" / "coder"
    ...
    def test_real_mode_repairs_parent_home_already_pointing_at_profile(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("OURO_REAL_HOME", str(real_home))
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("OURO_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("OURO_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_host_auto_preserves_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["OURO_REAL_HOME"] == str(real_home)
