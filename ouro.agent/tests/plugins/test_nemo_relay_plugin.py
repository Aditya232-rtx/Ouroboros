...
""",
    ...
    monkeypatch.setenv("OURO_NEMO_RELAY_PLUGINS_TOML", str(plugins_toml))
    return plugins_toml
...
def test_shared_metrics_and_rich_plugin_share_one_core_session(
    ...
    monkeypatch.setenv("OURO_NEMO_RELAY_ATIF_ENABLED", "1")
    monkeypatch.setenv(
        "OURO_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY", str(tmp_path / "atif")
    )
    monkeypatch.setattr(
