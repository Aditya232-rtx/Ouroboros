...
to a generic "Your API key was rejected... run ouro setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "ouro setup".
    assert "ouro portal" in source
