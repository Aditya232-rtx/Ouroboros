...
CA bundle env vars (OURO_CA_BUNDLE, REQUESTS_CA_BUNDLE, SSL_CERT_FILE)
...
_CA_ENV_VARS = ("OURO_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE")
...
class TestResolveRequestsVerify:
    ...
    def test_priority_hermes_over_requests(self, clean_env, tmp_path, bundle_file):
        ...
        clean_env.setenv("OURO_CA_BUNDLE", bundle_file)
