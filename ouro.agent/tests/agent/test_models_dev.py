...
class TestModelOverrides:
    ...
    def test_provider_key_accepts_either_id_space(self):
        """Override keyed by Ouro id resolves for models.dev id and back."""
        overrides = {
            "copilot": {
        ...
        with self._setup_overrides(overrides):
            # Caller passes the models.dev id; config keyed by Ouro id.
        ...
        with self._setup_overrides(overrides):
            # Caller passes the Ouro id; config keyed by models.dev id.
