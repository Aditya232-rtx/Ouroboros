...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated OURO_HOME, yield (agent, helpers)."""
    ...
    os.makedirs(os.path.join(test_home, ".ouro"))
    prev_home = os.environ.get("OURO_HOME")
    os.environ["OURO_HOME"] = os.path.join(test_home, ".ouro")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["OURO_HOME"] = prev_home
