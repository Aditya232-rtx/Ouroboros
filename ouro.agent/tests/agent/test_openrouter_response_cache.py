...
class TestEnvVarOverrides:
    ...
    def test_invalid_env_ttl_dropped(self, monkeypatch, ttl):
        ...
        monkeypatch.setenv("OURO_OPENROUTER_CACHE", "1")
        monkeypatch.setenv("OURO_OPENROUTER_CACHE_TTL", ttl)
    ...
    def test_valid_env_ttl_boundaries(self, monkeypatch, ttl):
        ...
        monkeypatch.setenv("OURO_OPENROUTER_CACHE", "yes")
        monkeypatch.setenv("OURO_OPENROUTER_CACHE_TTL", ttl)
    ...
    def test_no_env_vars_falls_through_to_config(self, monkeypatch):
        ...
        monkeypatch.delenv("OURO_OPENROUTER_CACHE", raising=False)
        monkeypatch.delenv("OURO_OPENROUTER_CACHE_TTL", raising=False)
