...
binary download are exercised manually by `ouro secrets bitwarden
...
def hermes_home(tmp_path, monkeypatch):
    """Point Ouro at an isolated home directory."""
    home = tmp_path / ".ouro"
    home.mkdir()
    monkeypatch.setenv("OURO_HOME", str(home))
    # Some modules cache get_hermes_home; clear if needed.
    import hermes_constants
    if hasattr(hermes_constants, "_OURO_HOME_CACHE"):
        hermes_constants._OURO_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
