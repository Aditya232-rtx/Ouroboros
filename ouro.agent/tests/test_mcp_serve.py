"""
Tests for mcp_serve — Ouro MCP server.
...
def _isolate_hermes_home(tmp_path, monkeypatch):
    """Redirect OURO_HOME to a temp directory."""
...
class TestEventBridgePollE2E:
    ...
    def test_poll_picks_up_new_conversation_on_db_change(
        ...
        # _poll_once reads <OURO_HOME>/state.db for its mtime gate; the autouse
        # fixture points OURO_HOME at tmp_path.
        db_path = tmp_path / "state.db"
