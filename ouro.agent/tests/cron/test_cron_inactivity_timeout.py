...
- Unlimited timeout (OURO_CRON_TIMEOUT=0)
- Backward compat: OURO_CRON_TIMEOUT env var still works
...
class TestInactivityTimeout:
    ...
    def test_unlimited_timeout(self):
        """OURO_CRON_TIMEOUT=0 means no timeout at all."""
        agent = FakeAgent(idle_seconds=0.0)
    ...
    def test_timeout_env_var_parsing(self, monkeypatch):
        """OURO_CRON_TIMEOUT env var is respected."""
        monkeypatch.setenv("OURO_CRON_TIMEOUT", "1200")
