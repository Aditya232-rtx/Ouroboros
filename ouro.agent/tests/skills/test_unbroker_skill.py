...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and ouro-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # ouro-agent (tests/skills/)
]
