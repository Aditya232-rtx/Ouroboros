...
opts in with --run-e2e or OURO_RUN_E2E=1.  This is intentional — the test
...
pytestmark = pytest.mark.skipif(
    os.environ.get("OURO_RUN_E2E", "0") != "1",
    reason="E2E proxy test — set OURO_RUN_E2E=1 to run (requires network + curl + openssl)",
)
