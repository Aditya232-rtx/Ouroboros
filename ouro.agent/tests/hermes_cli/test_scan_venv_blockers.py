...
def test_classify_local_preview_args_preserves_full_directory_label_and_port() -> None:
    args = [
        r"C:\Ouro\venv\Scripts\python.exe",
        "-m",
        "http.server",
        "8766",
        "--bind",
...
#
# `hermes-setup` always invokes `ouro update --yes --gateway`, whose
...
@pytest.mark.parametrize(
    ...
    [
        ...
        r"C:\Users\u\AppData\Local\hermes\ouro-agent\venv\Scripts\python.exe"
...
def test_main_gateway_with_long_managed_runtime_path_is_exempt(monkeypatch, capsys):
    ...
    exe path (`.ouro-runtime\python\generation-...\cpython-3.11-...`).
    ...
    """
    long_exe = (
        r'"C:\Users\u\AppData\Local\hermes\ouro-agent\.ouro-runtime\python'
