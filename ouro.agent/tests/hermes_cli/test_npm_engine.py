...
check: npm states the range it wants in the failure, Ouro upgrades only an
...
npm error engine Not compatible with your version of node/npm: ouro-agent@1.0.0
npm error notsup Not compatible with your version of node/npm: ouro-agent@1.0.0
...
class TestManagedDetection:
    ...
    no other npm — this is the boundary between "Ouro fixes it" and "the
...
class TestRepairDecision:
    ...
    def test_foreign_npm_provisions_managed_runtime_instead(
        ...
        """A system/nvm/brew/Nix npm is never modified — Ouro provisions its
