...
class TestGenerateDeepLink:
    ...
    def test_name_url_encoded(self):
        link = generate_deep_link(
            ...
            suggested_name="Ouro & Friends",
        )
        assert "Ouro+%26+Friends" in link
...
class TestCreatePairing:
    def test_success(self):
        ...
        mock_resp.json.return_value = {
            ...
            "deep_link": "https://t.me/newbot/HermesSetupBot/hermes_abcdefghijklmnop_bot?name=Ouro+Agent",
            "qr_payload": "https://t.me/newbot/HermesSetupBot/hermes_abcdefghijklmnop_bot?name=Ouro+Agent",
        ...
        with patch(
            ...
            pairing = create_pairing("https://api.example.com", bot_name="Ouro")
...
class TestSetupTelegramAuto:
    ...
    def test_setup_result_passes_profile_name_for_profile_home(self, monkeypatch, tmp_path):
        ...
        seen = {}
        profile_home = tmp_path / ".ouro" / "profiles" / "oracle"
