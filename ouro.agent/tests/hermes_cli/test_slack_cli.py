...
def _parse_slack_args(argv):
    """Build the real `ouro slack` parser and parse argv against it."""
...
class TestSlackFullManifest:
    """Generated full Slack app manifest used by `ouro slack manifest`."""
    ...
    def test_assistant_features_remain_enabled(self):
        manifest = _build_full_manifest("Ouro", "Your Ouro agent on Slack")
    ...
    def test_no_assistant_preserves_core_surface(self):
        ...
        manifest = _build_full_manifest(
            "Ouro", "Your Ouro agent on Slack", include_assistant=False
        )
