"""Tests for the ``ouro hooks`` CLI subcommand."""
...
def _isolated_home(tmp_path, monkeypatch):
    ...
    monkeypatch.delenv("OURO_ACCEPT_HOOKS", raising=False)
...
class TestHooksDoctor:
    ...
    def test_unallowlisted_script_is_not_executed(self, tmp_path):
        """Regression for M4: `ouro hooks doctor` used to run every
