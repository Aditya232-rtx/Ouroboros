"""Tests for the post-pull syntax guard in ``ouro update``.
...
markers in ``hermes_cli/config.py``; users who ran ``ouro update`` in
...
# release; if a future ``ouro update`` would brick users, this test fails
# in CI first.
# ---------------------------------------------------------------------------
