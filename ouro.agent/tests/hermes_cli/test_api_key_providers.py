...
_EXTRA_ENV_VARS = (
    ...
    "OURO_COPILOT_ACP_COMMAND", "COPILOT_CLI_PATH",
    "OURO_COPILOT_ACP_ARGS", "COPILOT_ACP_BASE_URL",
)
...
class TestRuntimeProviderResolution:
    ...
    def test_runtime_copilot_acp_uses_process_runtime(self, monkeypatch):
        ...
        monkeypatch.setenv("OURO_COPILOT_ACP_ARGS", "--acp --stdio --debug")
...
class TestHasAnyProviderConfigured:
    ...
    def test_claude_code_creds_ignored_on_fresh_install(self, monkeypatch, tmp_path):
        """Claude Code credentials should NOT skip the wizard when Ouro is unconfigured."""
