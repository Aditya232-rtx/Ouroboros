...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.ouro/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.ouro/memories/MEMORY.md"},
