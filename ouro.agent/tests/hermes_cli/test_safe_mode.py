"""Tests for `ouro chat --safe-mode` isolation."""
...
_VARS = ("OURO_SAFE_MODE", "OURO_IGNORE_USER_CONFIG", "OURO_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["OURO_SAFE_MODE"] == "1"
        assert os.environ["OURO_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["OURO_IGNORE_RULES"] == "1"
        return True
