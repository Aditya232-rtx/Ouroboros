...
def test_timezone_honors_managed(homes, monkeypatch):
    ...
    monkeypatch.delenv("OURO_TIMEZONE", raising=False)
...
def test_gateway_env_bridge_honors_managed(homes, monkeypatch):
    ...
    every turn (OURO_TIMEZONE, OURO_REDACT_SECRETS, OURO_MAX_ITERATIONS,
    ...
    # writing OURO_TIMEZONE = cfg["timezone"]. Prove the overlay flips the value.
    import yaml
