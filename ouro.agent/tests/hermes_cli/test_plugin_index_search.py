...
(remote → cache → seed), `ouro plugins search --json`, and install-time
...
SAMPLE = _index_doc(
    [
        ...
        },
        {
            ...
            "author": "NousResearch",
            "tags": ["example", "llm"],
            "repo": "Aditya232-rtx/ouro-example-plugins",
...
class TestParsing:
    def test_parses_object_form(self):
        ...
        assert entries[2].install_identifier == (
            "Aditya232-rtx/ouro-example-plugins/plugin-llm-example"
        )
...
class TestResolveName:
    ...
    def test_case_insensitive(self):
        entry, _ = resolve_name(self.entries, "Ouro-Media-Studio")
