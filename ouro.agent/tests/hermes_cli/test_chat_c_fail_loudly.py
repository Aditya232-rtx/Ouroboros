...
Regression for #86794: a background/quiet `ouro chat -c "<title>" -q "..."`
...
def isolated_home(tmp_path, monkeypatch):
    """Point OURO_HOME at a temp dir so session creation stays isolated."""
...
class TestChatCFailLoudlyOnStderr:
    ...
    def test_missing_session_fails_on_stderr(self, isolated_home, monkeypatch):
        ...
        assert not stderr_lines[0].startswith("Use 'ouro sessions list'")
