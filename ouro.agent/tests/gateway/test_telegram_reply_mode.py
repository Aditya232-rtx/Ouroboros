...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/Aditya232-rtx/ouro/issues/23994:
    reply_to_mode 'off' was ignored when sending via Ouro-created DM topic
...
class TestDMTopicSyntheticSendRouting:
    ...
    Regression tests for https://github.com/Aditya232-rtx/ouro/issues/87051:
    ...
    response in a different chat lane than the Ouro topic the session runs
    in. The no-anchor branch must prefer the Ouro topic's
