...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.ouro/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hermes_state import time, before pytest's OURO_HOME monkeypatch
    fires — the autouse fixture's OURO_HOME override doesn't help here.)
    """
    import hermes_state
