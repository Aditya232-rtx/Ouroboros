...
class TestIsBotMentioned:
    ...
    def test_localpart_in_body(self):
        assert self.adapter._is_bot_mentioned("ouro can you help?")


    def test_matrix_pill_in_formatted_body(self):
        html = '<a href="https://matrix.to/#/@hermes:example.org">Ouro</a> help'
        assert self.adapter._is_bot_mentioned("Ouro help", html)
    ...
    def test_m_mentions_user_ids_authoritative(self):
        ...
        assert self.adapter._is_bot_mentioned(
            "please reply",  # no @ouro anywhere in body
...
class TestStripMention:
    ...
    def test_localpart_preserved(self):
        ...
        result = self.adapter._strip_mention("ouro help me")
        assert result == "ouro help me"
