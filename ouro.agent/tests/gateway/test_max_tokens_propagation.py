...
Precedence verified here:
    OURO_MAX_TOKENS env  >  model.max_tokens  >  per-provider
...
def isolated_home(tmp_path, monkeypatch):
    """Isolated OURO_HOME with a writable config.yaml and a clean module cache.
    ...
    monkeypatch.delenv("OURO_MAX_TOKENS", raising=False)
