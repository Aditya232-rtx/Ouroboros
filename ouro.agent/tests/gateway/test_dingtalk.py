...
class TestSend:
    ...
    async def test_send_posts_to_webhook(self):
        ...
        assert payload["markdown"]["title"] == "Ouro"
...
class TestMentionPatterns:
    ...
    def test_pattern_matches_text(self, monkeypatch):
        ...
        assert adapter._message_matches_mention_patterns("ouro please help") is True
        assert adapter._message_matches_mention_patterns("please ouro help") is False
