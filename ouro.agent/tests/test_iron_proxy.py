...
def hermes_home(tmp_path, monkeypatch):
    """Point OURO_HOME at a temp dir so install paths don't touch the real $HOME."""
...
def test_docker_egress_node_options_uses_sentinel(hermes_home, monkeypatch):
    ...
    ``_OURO_EGRESS_NODE_OPTIONS_APPEND`` so DockerEnvironment can
    ...
    assert env.get("_OURO_EGRESS_NODE_OPTIONS_APPEND") == "--use-openssl-ca"
