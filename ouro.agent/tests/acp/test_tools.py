...
COMMON_OURO_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_hermes_tools_have_kind(self):
        """Every common ouro tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_OURO_TOOLS:
