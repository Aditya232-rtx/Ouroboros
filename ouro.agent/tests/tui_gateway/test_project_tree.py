...
def test_junk_root_never_becomes_an_auto_project():
    # A session whose git root is OURO_HOME (config/state) must not spawn a
    # phantom project; it lands in the Home bucket. A real repo alongside it
    # still groups normally.
    resolve = _resolver(
        {
            "/home/me/.ouro": ("/home/me/.ouro", "/home/me/.ouro"),
            "/www/app": ("/www/app", "/www/app"),
        }
    )
    junk = _session("/home/me/.ouro", branch="main")
    real = _session("/www/app", branch="main")
    is_junk = lambda root: root == "/home/me/.ouro"
...
def test_broad_default_non_git_cwd_stays_unscoped():
    detached = _session("/home/test/.ouro")
    ...
    tree = pt.build_tree(
        ...
        hydrate=True,
        is_junk_cwd=lambda path: path in {"/home/test", "/home/test/.ouro"},
    )
