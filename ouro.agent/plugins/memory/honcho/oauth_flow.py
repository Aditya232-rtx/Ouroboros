...
# The loopback redirect registered for the Ouro OAuth client. IP-literal so
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to Ouro.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local OURO_HOME override can't reach.
