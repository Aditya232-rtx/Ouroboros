...
Config: ~/.ouro/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.ouro/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (OURO_HOME-aware and
