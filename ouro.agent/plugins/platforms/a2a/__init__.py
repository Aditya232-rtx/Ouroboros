"""
A2A (Agent-to-Agent) plugin for Ouro.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Ouro as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`ouro gateway setup` flow for A2A."""
    ...
    print_info("Expose Ouro as an A2A-discoverable agent and call other A2A agents.")
