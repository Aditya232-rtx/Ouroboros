...
# When the user hasn't picked a reasoning effort, Ouro passes
...
# ON at this effort — matching the "medium (default)" that Ouro' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Ouro' effort vocabulary onto Solar's accepted set. xhigh/max/
