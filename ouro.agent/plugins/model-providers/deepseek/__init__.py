...
the contract that subsequent turns echo it back; combined with how Ouro
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Ouro remaps
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Ouro, so they are not listed here.
    """
