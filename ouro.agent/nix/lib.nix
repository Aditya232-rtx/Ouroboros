      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via OURO_BUNDLED_SKILLS /
            # OURO_OPTIONAL_SKILLS (see ouro-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + OURO_BUNDLED_LOCALES
            # / OURO_OPTIONAL_MCPS, not via the wheel. Excluding them
