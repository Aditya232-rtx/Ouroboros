...
Write path is the CLI (``ouro cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`ouro cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `ouro cron notepad {job_id} delete "
