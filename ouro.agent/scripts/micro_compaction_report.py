#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Ouro logs.
...
With no LOGFILE, reads ``$OURO_HOME/logs/agent.log`` (default ~/.ouro).
...
def default_log() -> Path:
    home = os.environ.get("OURO_HOME") or str(Path.home() / ".ouro")
