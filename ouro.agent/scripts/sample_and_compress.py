...
DEFAULT_DATASETS = [
    ...
    "Aditya232-rtx/ouro-megascience-sft1",
    "NousResearch/Ouro-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Ouro-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-ouro-agent"
]
