#!/usr/bin/env python3
"""Build the Ouro Skills Index — a centralized JSON catalog of all skills.
...
`ouro skills search/install` can use it without hitting the GitHub API.
...
# Ensure OURO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Ouro Skills Index...", flush=True)
