#!/usr/bin/env python3
"""Build the Ouro Model Catalog — a centralized JSON manifest of curated models.
...
Ouro CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Ouro release.
...
# Ensure OURO_HOME is set for imports that touch it at module level.
os.environ.setdefault("OURO_HOME", os.path.join(os.path.expanduser("~"), ".ouro"))
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "ouro-agent repo",
            "docs": "https://ouro.dev/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Ouro '
