...
LEGACY_AUTHOR_MAP = {
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level OURO_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (ouro journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.ouro/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on ouro mcp add)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (OURO_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (OURO_HOME inject)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Ouro runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level OURO_HOME state files)
    ...
    "zhchl@ouro-agent.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Ouro
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/Aditya232-rtx/ouro",
    ...
    lines.append(f"# Ouro v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Ouro. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Ouro Release Tool")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Ouro v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Ouro v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Ouro v{new_version} ({calver_date})' "
