...
# optimized via ``ouro sessions optimize-storage``. A legacy DB sits at
...
# `ouro sessions optimize-storage` rebuilds it on a capable host.
...
# triggers repairable UNTIL the user opts into `ouro db optimize`. This is
